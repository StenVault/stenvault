 ...
 * StorageSettings.
 *
 * ProfileSettings stays intact; restyling its inline "Danger Zone" to
 * the sunken DangerZone primitive is deferred. The DeleteAccountDialog
 * flow stays as-is — it carries OPAQUE password proof + pre-delete
 * blockers + data-export prompt, all of which the bare DangerZone
 * primitive would discard.
 */
