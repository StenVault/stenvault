...
export const LANDING_COLORS = {
    ...
    // Editorial V4 — Glassmorphism + Prism palette
    ...
    accentVivid: '#A78BFA',       // Violet-400 (prism refractions)
    ...
    pipelineSource: '#818CF8',       // Indigo-400 — plain file
    pipelineEncrypt: '#6366F1',      // Indigo-500 — encrypting
    pipelineStore: '#4338CA',        // Indigo-700 — stored
    pipelineDecrypt: '#10B981',      // Emerald-500 — decrypted
